...
// "Me sumo" (confirmar inscripción)  → haptics.heavy() \+ haptics.success()
...
────────────────────────────────────────────────────────────────
  ...
  │  Button filled navy-500 · height 44pt · full width  │
  ...
  VARIANTES DEL BOTÓN en card feed:

  disponible  → Button filled navy-500  "Me sumo"
               → Tap abre ConfirmSheet sin navegar al detalle
               → haptics.medium()

  inscripto   → Badge success "Confirmado ✓" en lugar del botón
               → Tap en la card navega a EventDetail

  completo    → Button disabled sand-300  "Sin cupos"
               → Tap en la card navega a EventDetail
  ...
  → Tap en card (fuera del botón) → pantalla EventDetail

  → Tap en botón "Me sumo" → abre ConfirmSheet directamente

  → haptics.light() al tocar la card

  → haptics.medium() al tocar el botón "Me sumo"
...
LAYOUT:
  ...
  │  $precio o "Gratuito"  labelMd  \+  Button "Me sumo" lg  │
...
VARIANTES DEL CTA STICKY:
  ...
  disponible  → Button filled navy "Me sumo"
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  └── Botón CTA: "Me sumo al plan Caminata al atardecer. Botón."
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  "Me sumo" → haptics.heavy() \+ haptics.success()
